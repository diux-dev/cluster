#!/usr/bin/env python
#
# Launch iperf evaluation, following instructions in
...
def main():
  ...
  worker_job = run.make_job('worker', instance_type=args.instance_type,
                            num_tasks=2)
  ps_job = run.make_job('ps', instance_type=args.instance_type,
                            num_tasks=2)
